...
<div class="image-33-text-66-container">
    <img src="{{ "/assets/media/election_candidates/Alicia_Muriel.jpg" | relative_url }}" alt="Alicia_Muriel" />
    <div class="text-content"><h4>Alicia Muriel</h4>Centre for Palaeogenetics,
...
<!-- Anna-Lena Titze -->
<div class="image-33-text-66-container">
    <img src="{{ "/assets/media/election_candidates/Anna-Lena_Titze.jpg" | relative_url }}" alt="Avatar" />
    <div class="text-content"><h4>Anna-Lena Titze</h4>Centre for Anthropobiology and Genomics of Toulouse,
UMR-5288,
...
<!-- Aurore Galtier -->
<div class="image-33-text-66-container">
    <img src="{{ "/assets/media/election_candidates/Aurore_Galtier.jpg" | relative_url }}" alt="Avatar" />
    <div class="text-content"><h4>Aurore Galtier</h4>Advanced DNA Sequencing Techniques and Evolutionary Genomics,
Dept. Archaeogenetics and Evolutionary Genomics,
...
<!-- Cecilia Padilla -->
<div class="image-33-text-66-container">
    <img src="{{ "/assets/media/election_candidates/Cecilia_Padilla.jpg" | relative_url }}" alt="Avatar" />
    <div class="text-content"><h4>Cecilia Padilla</h4>Evolutionary Ecology Group,
    Dept. of Zoology,
    University of Cambridge,
    Cambridge, United Kingdom</div>
</div>
...
<!-- Sanni Peltola -->
<div class="image-33-text-66-container">
    <img src="{{ "/assets/media/election_candidates/Sanni_Peltola.jpg" | relative_url }}" alt="Avatar" />
    <div class="text-content"><h4>Sanni Peltola</h4>SUMRAGEN / KAROL projects,
    University of Turku,
